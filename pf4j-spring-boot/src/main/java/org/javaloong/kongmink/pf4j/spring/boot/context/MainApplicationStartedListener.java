 ...
 */
@Component
public class MainApplicationStartedListener implements ApplicationListener<ApplicationStartedEvent> {
    ...
    public void onApplicationEvent(ApplicationStartedEvent event) {
        ...
        pluginManager.getPlugins(PluginState.STARTED).forEach(pluginWrapper -> {
            ...
            pluginAppCtx.publishEvent(new MainApplicationStartedEvent(applicationContext));
        });
