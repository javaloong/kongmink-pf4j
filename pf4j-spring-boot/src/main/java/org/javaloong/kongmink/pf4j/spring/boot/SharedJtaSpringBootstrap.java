...
/**
 * Introduce central Jta transaction management between main application and plugins, which
...
public class SharedJtaSpringBootstrap extends SpringBootstrap {
    ...
    public SharedJtaSpringBootstrap(SpringBootPlugin plugin, Class<?>... primarySources) {
